  ...
  $.fn.tooltip = function (options) {
    ...
    return this.each(function () {
      ...
      // Mouse In
        ...
        // Добавляем обработчик события для material-tooltip
        tooltipEl.on({
          'mouseenter.tooltip': function () {
          // Предотвращаем закрытие меню при наведении на него
          started = true;
          clearTimeout(timeoutRef);
          },
          'mouseleave.tooltip': function () {
          // Обрабатываем событие, когда мышь уходит из material-tooltip
          started = false;
          tooltipEl.velocity({
        ...
        function scroll(x) {
          ...
          if (!noWrap || center >= 0 && center < count) {
            ...
            if (!$(el).hasClass('active')) {
              ...
              view.find('.carousel-item').removeClass('tooltipped');
              $(el).addClass('active');
